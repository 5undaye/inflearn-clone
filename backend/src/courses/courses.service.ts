...
export class CoursesService {
    ...
    async createReview(
        ...
        if (!enrollment) {
            throw new UnauthorizedException('수강신청한 강의만 리뷰를 작성하실 수 있습니다.');
        }
    ...
    async createInstructorReply(
        ...
        const updateReview = await this.prisma.courseReview.update({
            where: {
                id: reviewId,
            },
            data: {
        ...
        return updateReview as unknown as CourseReviewEntity;
    }
}
