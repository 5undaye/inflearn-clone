...
export class QuestionsService {
    ...
    async create(userId: string, courseId: string, createQuestionDto: CreateQuestionDto) {
        ...
        if (!enrollment) {
            throw new ForbiddenException('수강 신청하신 강의에만 질문을 작성하실 수 있습니다.');
        }
    ...
    async update(userId: string, questionId: string, updateQuestionDto: UpdateQuestionDto) {
        const question = await this.prisma.courseQuestion.findUnique({
            where: { id: questionId },
        });
